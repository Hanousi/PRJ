...
public class MainScript : MonoBehaviour
{
    ...
    {
        GameLevel game1 = new GameLevel(1, new float[][] { new float[] { 1, 4, 7, 10, 13, 16 },
            new float[] { },
        ...
        GameLevel game2 = new GameLevel(2, new float[][] { new float[] { 2, 4, 6, 8, 10, 12, 14, 16 },
            new float[] { },
        ...
        GameLevel game3 = new GameLevel(3, new float[][] { new float[] { 1, 2, 3, 4, 5, 7, 9, 11 },
            new float[] { },
            new float[] { },
            new float[] { },
            new float[] { },
